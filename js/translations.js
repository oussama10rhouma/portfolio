...
const translations = {
    fr: {
        ...
        proj_docrag_title: "DocRAG-MD — Plateforme RAG Médicale Multi-Agents",
        proj_docrag_desc: "Plateforme clinique de Q&A multi-agents avec routage LLM, GraphRAG via PrimeKG (100K+ nœuds, 4M+ arêtes), Self-RAG et Deep Search sur 301K chunks StatPearls + 36M+ articles PubMed. 4 agents LangGraph spécialisés (diagnostic, pharmacologie, général, évaluateur), 4 LLMs (Gemini 2.5, BioMistral 7B local, GPT-4o), CRAG confidence gating et observabilité Langfuse. Frontend React, serveur MCP (FastMCP). 62%+ de précision MedMCQA. 11 services Docker.",
    ...
    en: {
        ...
        proj_docrag_title: "DocRAG-MD — Multi-Agent Medical RAG Platform",
        proj_docrag_desc: "Production-grade clinical Q&A platform with multi-agent LLM routing, GraphRAG via PrimeKG (100K+ nodes, 4M+ edges), Self-RAG and Deep Search over 301K StatPearls chunks + 36M+ PubMed articles. 4 specialized LangGraph agents (diagnosis, pharmacology, general, evaluator), 4 LLMs (Gemini 2.5, BioMistral 7B local, GPT-4o), CRAG confidence gating and Langfuse observability. React frontend, MCP server (FastMCP). 62%+ MedMCQA accuracy. 11 Docker services.",
